...
class Metronome {
    constructor(soundController) {
        ...
        this.btnSession1 = document.getElementById('btnSession1');
        this.btnSession2 = document.getElementById('btnSession2');
        this.btnSession3 = document.getElementById('btnSession3');
        this.btnSession4 = document.getElementById('btnSession4');
        this.btnSession5 = document.getElementById('btnSession5');
        this.btnSession6 = document.getElementById('btnSession6');

        this.tick = this.tick.bind(this);
        this.incrementBpm = this.incrementBpm.bind(this);
        this.decrementBpm = this.decrementBpm.bind(this);

        this.session1bpm = this.session1bpm.bind(this);
        this.session2bpm = this.session2bpm.bind(this);
        this.session3bpm = this.session3bpm.bind(this);
        this.session4bpm = this.session4bpm.bind(this);
        this.session5bpm = this.session5bpm.bind(this);
        this.session6bpm = this.session6bpm.bind(this);
    ...
    addEventListeners() {
        ...
        let bpmChange = function (func, ms) {
            ms = ms || 33;
            func();
            this.bpmChangeTimeout = setTimeout(function () {
                bpmChange(func);
            }, ms);
        }.bind(this);
        this.upArrow.onmousedown = function () {
            bpmChange(this.incrementBpm, 250);
        }.bind(this);
        this.downArrow.onmousedown = function () {
            bpmChange(this.decrementBpm, 250);
        }.bind(this);
        window.addEventListener('mouseup', function (event) {
            clearTimeout(this.bpmChangeTimeout);
        }.bind(this));
        this.upArrow.onmouseout = this.downArrow.onmouseout = function (event) {
            clearTimeout(this.bpmChangeTimeout);
        }.bind(this);
        ...
        this.btnSession1.onmousedown = function () {
            bpmChange(this.session1bpm, 250);
        }.bind(this);
        this.btnSession2.onmousedown = function () {
            bpmChange(this.session2bpm, 250);
        }.bind(this);
        this.btnSession3.onmousedown = function () {
            bpmChange(this.session3bpm, 250);
        }.bind(this);
        this.btnSession4.onmousedown = function () {
            bpmChange(this.session4bpm, 250);
        }.bind(this);
        this.btnSession5.onmousedown = function () {
            bpmChange(this.session5bpm, 250);
        }.bind(this);
        this.btnSession6.onmousedown = function () {
            bpmChange(this.session6bpm, 250);
        }.bind(this);
    ...
    loadMenu() {
        for (let k in SOUNDS) {
            ...
            newButton.onclick = function () {
                ...
                return function () {
                    this.changeAudio(k);
                    if (!metronome.isPlaying) this.playOnce();
                }
            }().bind(this);
    ...
    loadSounds() {
        for (let k in SOUNDS) {
            ...
            request.onload = function () {
                ...
                let soundName = k;
                return function () {
                    this.ctx.decodeAudioData(localRequest.response, function (buffer) {
                        console.log('Loaded ' + soundName + ' sound data');
                        this.soundData[soundName] = buffer;
                    }.bind(this), window.onError);
                }
            }().bind(this);
            request.send();
        }
